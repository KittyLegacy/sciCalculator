...
btnSq = Button(calc, text="√", width=6, height=2, font=('arial', 20, 'bold'), bd=4, bg="white", 
...
btnAdd = Button(calc, text="+", width=6, height=2, font=('arial', 20, 'bold'), bd=4, bg="white", 
                command = lambda: added_value.numberEnter("add")).grid(row=1, column=3, pady=1)

btnSub = Button(calc, text="-", width=6, height=2, font=('arial', 20, 'bold'), bd=4, bg="white", 
                command = lambda: added_value.numberEnter("sub")).grid(row=2, column=3, pady=1)
btnMult = Button(calc, text="*", width=6, height=2, font=('arial', 20, 'bold'), bd=4, bg="white", 
                 command = lambda: added_value.numberEnter("multi")).grid(row=3, column=3, pady=1)
btnDiv = Button(calc, text="÷", width=6, height=2, font=('arial', 20, 'bold'), bd=4, bg="white", 
                command = lambda: added_value.numberEnter("divide")).grid(row=4, column=3, pady=1)
...
btnPm = Button(calc, text=chr(177), width=6, height=2, font=('arial', 20, 'bold'), bd=4,
                  bg="white").grid(row=5, column=2, pady=1)
btnEquals = Button(calc, text="=", width=6, height=2, font=('arial', 20, 'bold'), bd=4, bg="white", 
                   command = added_value.sum_of_total).grid(row=5, column=3, pady=1)
#======================Scientific Calculator=================

btnPi = Button(calc, text="n", width=6, height=2, font=('arial', 20, 'bold'), bd=4, bg="white",
...
btnCos = Button(calc, text="cos", width=6, height=2, font=('arial', 20, 'bold'), bd=4, bg="white", 
                command = lambda: added_value.cos).grid(row=1, column=5, pady=1)

btntan= Button(calc, text="tan", width=6, height=2, font=('arial', 20, 'bold'), bd=4, bg="white", 
               command = lambda: added_value.tan).grid(row=1, column=6, pady=1)

btnSin = Button(calc, text="sin", width=6, height=2, font=('arial', 20, 'bold'), bd=4, bg="white",
                command = lambda: added_value.sin).grid(row=1, column=7, pady=1)

#======================################======================

btn2Pi = Button(calc, text="2n", width=6, height=2, font=('arial', 20, 'bold'), bd=4, bg="white", 
                command = lambda: added_value.tau).grid(row=2, column=4, pady=1)

btnCosh = Button(calc, text="cosh", width=6, height=2, font=('arial', 20, 'bold'), bd=4, bg="white",
                 command = lambda: added_value.cosh).grid(row=2, column=5, pady=1)

btntanh = Button(calc, text="tanh", width=6, height=2, font=('arial', 20, 'bold'), bd=4, bg="white", 
                 command = lambda: added_value.tanh).grid(row=2, column=6, pady=1)

btnSinh = Button(calc, text="sinh", width=6, height=2, font=('arial', 20, 'bold'), bd=4, bg="white", 
                 command = lambda: added_value.sinh).grid(row=2, column=7, pady=1)
...
btnExp = Button(calc, text="Exp", width=6, height=2, font=('arial', 20, 'bold'), bd=4, bg="white", 
                command = lambda: added_value.exp).grid(row=3, column=5, pady=1)

btnMod = Button(calc, text="Mod", width=6, height=2, font=('arial', 20, 'bold'), bd=4, bg="white", 
                command = lambda: added_value.numberEnter("mod")).grid(row=3, column=6, pady=1)
...
btnlog2 = Button(calc, text="log2", width=6, height=2, font=('arial', 20, 'bold'), bd=4, bg="white", 
                 command = lambda: added_value.log2).grid(row=4, column=4, pady=1)

btndeg = Button(calc, text="deg", width=6, height=2, font=('arial', 20, 'bold'), bd=4, bg="white", 
                command = lambda: added_value.degrees).grid(row=4, column=5, pady=1)

btnacosh = Button(calc, text="acosh", width=6, height=2, font=('arial', 20, 'bold'), bd=4, bg="white", 
                  command = lambda: added_value.cosh).grid(row=4, column=6, pady=1)

btnasinh = Button(calc, text="asinh", width=6, height=2, font=('arial', 20, 'bold'), bd=4, bg="white", 
                  command = lambda: added_value.sinh).grid(row=4, column=7, pady=1)

#======================################======================

btnlog10 = Button(calc, text="log10", width=6, height=2, font=('arial', 20, 'bold'), bd=4, bg="white", 
                  command = lambda: added_value.log10).grid(row=5, column=4, pady=1)

btnCos = Button(calc, text="log1p", width=6, height=2, font=('arial', 20, 'bold'), bd=4, bg="white", 
                command = lambda: added_value.cos).grid(row=5, column=5, pady=1)

btnexpm1 = Button(calc, text="exmp1", width=6, height=2, font=('arial', 20, 'bold'), bd=4, bg="white", 
                  command = lambda: added_value.expm1).grid(row=5, column=6, pady=1)

btnlgamma = Button(calc, text="lgamma", width=6, height=2, font=('arial', 20, 'bold'), bd=4, bg="white", 
                   command = lambda: added_value.lgamma).grid(row=5, column=7, pady=1)

lb1Display = Label(calc, text="Scientific Calculator", font=('arial', 30, 'bold'), justify=CENTER)
